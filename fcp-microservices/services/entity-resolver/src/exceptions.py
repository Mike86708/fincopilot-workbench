...
class EntityResolverException(FincopilotException):
    '''
    Entity Resolver Exception
    '''
    message = f"An error occurred in the Entity Resolver api"
    component = f"Entity Resolver general"