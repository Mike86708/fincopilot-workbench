...
from lib.exception.exception_codes import *
...
class FincopilotException(Exception):
    ...
    component = "unknown"
    metadata = {}
    # metadata={"service_name": "balance_summary", "source_name": "lambda_handler"}
    ...
    def append_metadata(self, kwargs):
        ...
        if 'subcomponent' in kwargs:
            ...
            self.metadata = {
                ...
                "service_name": "accounting_activity",
                "source_name": "account_controller"
            }
...
class AccountingActivityException(FincopilotException):
    message = f"An error occurred in Accounting Activity API"
    component = f"Accounting Activity general"