...
from lib.exception.exception_codes import Reason, Status
...
class BalanceSummaryException(FincopilotException):
    message = f"An error occurred in Balance Summary API"
    component = f"Balance Summary general"
