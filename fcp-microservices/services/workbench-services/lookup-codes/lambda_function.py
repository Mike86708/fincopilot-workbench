...
import configparser
from lookup_codes_exceptions import LookupCodesException, Reason
from psycopg2 import Error


"""
Lambda entry point for getting lookup codes
...
def lambda_handler(event, context):
    ...
    except LookupCodesException as e:
