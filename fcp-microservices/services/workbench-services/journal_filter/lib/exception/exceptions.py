...
class JournalFilterException(FincopilotException):
    message = f"An error occurred in Journal Filter API"
    component = f"Journal Filter general"
