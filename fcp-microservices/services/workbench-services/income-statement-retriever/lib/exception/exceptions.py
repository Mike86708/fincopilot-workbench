...
class IncomeStatementException(FincopilotException):
    message = f"An error occurred in Income Statement API"
    component = f"Income Statement general"