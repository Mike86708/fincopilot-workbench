    ...
    def append_metadata(self, kwargs):
        ...
        if 'subcomponent' in kwargs:
            ...
            self.metadata = {
                ...
                "service_name": "journal_controller",
                "source_name": "journal_controller"
            }
...
class JournalControllerException(FincopilotException):
    message = f"An error occurred in Journal Controller API"
    component = f"Journal Controller general"